...
from flask_backend.database_scripts.helper_account_scripts import add_helper_account, modify_helper_account, api_authentication
...
class RESTAccount(Resource):
    ...
    def post(self):
        ...
        add_response = add_helper_account(params_dict['email'], params_dict['password'],
    ...
    def put(self):
        ...
        modify_response = modify_helper_account(**params_dict)
